...
$text['javascript format'] = 'Javascript array format';
$text['gettext po format'] = 'Gettext .PO format';
$text['xdxf format'] = 'XDXF format';
$text['language pair'] = 'Language Pair:';
$text['<space>'] = '<SPACE>';
$text['<tab>'] = '<TAB>';
$text['gmt'] = 'GMT';
...
$text['word not found'] = 'word not found';
